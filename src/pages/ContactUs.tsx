  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Contact InstallPros for satellite internet installation quotes, support, or questions. Call (512) 807-0716 or fill out our contact form."
        />
      </Helmet>
          ...
          <section className="px-6 -mt-4 mb-12">
            <div className="max-w-4xl mx-auto grid sm:grid-cols-3 gap-4">
              ...
              >
                ...
                <p className="text-primary font-medium">(512) 807-0716</p>
