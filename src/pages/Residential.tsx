...
const Residential = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Residential Starlink Installation | InstallPros</title>
        <meta
          name="description"
          content="Professional residential Starlink installation. Roof mount, cable run, router setup. Nationwide."
        />
        <link rel="canonical" href="https://installpros.io/residential" />
      </Helmet>
