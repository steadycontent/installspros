...
const CTASection = ({ installCount = "7,000+", statesServed = "37", heading = "Ready for Satellite Internet?", subheading = "Join thousands of homeowners who trust InstallPros for professional satellite internet installations.", hidePhoneCTA = false }: CTASectionProps) => {
