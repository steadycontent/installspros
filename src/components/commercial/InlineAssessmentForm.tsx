...
const ALL_STEPS: Step[] = [
  ...
  { key: "propertyDetails", title: "Tell us about your property?", subtitle: "What are your connectivity needs?", type: "textarea", placeholder: "e.g. 120-site RV park on 35 acres, current internet is slow DSL...", icon: FileText },
  { key: "name", title: "What's your name?", subtitle: "So we know who we're talking to.", type: "text", placeholder: "First / Last", icon: User },
